...
class AirShip extends SpriteComponent with HasGameRef<CrowGame> {
  ...
  void update(double dt) {
    ...
    if (gameRef.elapsedTime.elapsed.inSeconds > 40 && x > gameRef.crow.x) {
      if (gameRef.crow.y > y) {
        y += 3 * dt;
      } else {
        y -= 3 * dt;
